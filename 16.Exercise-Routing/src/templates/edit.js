...
import { updateDetails } from '../requests/requests.js';
...
const editHandler = (id, e) => {
    ...
    updateDetails(Object.fromEntries([...formData]), getUser().accessToken, id);
    page.redirect('/dashboard');
}

export const editTemplate = (id) => html`
    <header>
        ${navigation()}
    </header>
    <div class="container">
        ...
        <form @submit=${editHandler.bind(this, id)}>
            <div class="row space-top">
                <div class="col-md-4">
